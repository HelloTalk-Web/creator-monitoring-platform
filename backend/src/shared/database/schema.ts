...
export const creatorAccounts = pgTable('creator_accounts', {
  ...
  bio: text('bio'),
  followerCount: bigint('follower_count', { mode: 'bigint' }).default(0),
  followingCount: bigint('following_count', { mode: 'bigint' }).default(0),
...
export const videos = pgTable('videos', {
  ...
  viewCount: bigint('view_count', { mode: 'bigint' }).default(0),
  likeCount: bigint('like_count', { mode: 'bigint' }).default(0),
  commentCount: bigint('comment_count', { mode: 'bigint' }).default(0),
  shareCount: bigint('share_count', { mode: 'bigint' }).default(0),
  saveCount: bigint('save_count', { mode: 'bigint' }).default(0),
